...
public class DbHandler extends SQLiteOpenHelper {
    ...
    // Add a single order
    public void addToDo(Order toDo){
    ...
    // Get all orders into a list
    public List<Order> getAllToDos(){

        List<Order> toDos = new ArrayList();
        SQLiteDatabase db = getReadableDatabase();
        String query = "SELECT * FROM "+TABLE_NAME;
    ...
    // Get a single order
    public Order getSingleToDo(int id){
        SQLiteDatabase db = getWritableDatabase();
    ...
    public int updateSingleToDo(Order toDo){
        SQLiteDatabase db = getWritableDatabase();
